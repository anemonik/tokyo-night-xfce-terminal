...
__help() {
  printf "${_ctb}Usage: ${_ct_primary}install_light.sh ${_ctb_subtle}[OPTIONS]\n"
...
NORD_XFCE_TERMINAL_SCRIPT_OPTS=`getopt -o vht: --long verbose,help,themefile: -n 'install_light.sh' -- "$@"`
THEME_FILE=files/tokyo_light.theme
VERBOSE=false
